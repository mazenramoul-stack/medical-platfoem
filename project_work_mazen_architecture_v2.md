...
|---|---|---|---|---|---|
| MRI | **Swin Transformer** (4-class) | shifted-window hierarchical ViT, 224² | ~86 M, ~350 MB | fine-tuned local `vit_brain_tumor/` (95.4 %) else stock HF (80.4 %) | notumor gate ≥ 0.99 AND U-Net empty, else `possible_tumor_review` |
