# Vendored verbatim from https://github.com/ycq091044/BIOT  (model/biot.py)
# BIOT: Biosignal Transformer for Cross-data Learning in the Wild
# Yang, Westover, Sun — NeurIPS 2023.  MIT License, (c) 2023 Chaoqi Yang.
# Only cosmetic header added; model definitions are unchanged so released
# pretrained encoder checkpoints load with strict key matching.
import math
