...
export default {
  en: {
    ...
    explain: {
      ...
      caveat: 'Signal-level saliency — which leads and segments drove the prediction — not clinical reasoning.',
      attributing: 'Attributing',
      perLead: 'Per-lead importance',
      topLeads: 'Top leads',
      pickPathology: 'Pathology to explain',
      primaryOption: 'Primary diagnosis',
    },
    status: {
      completed: 'completed',
    ...
    hrv: {
      ...
      names: {
        ...
        pNN50: 'Successive NN intervals differing > 50 ms',
      },
    },
    table: {
      code: 'Code',
      ...
      maybeNote: '{margin}% from its threshold — closest to detection',
      ...
      legendMaybe: 'Likely (closest to threshold)',
  ...
  fr: {
    ...
    explain: {
      ...
      caveat: 'Saillance au niveau du signal — quelles dérivations et segments ont motivé la prédiction — et non un raisonnement clinique.',
      attributing: 'Attribution',
      perLead: 'Importance par dérivation',
      topLeads: 'Dérivations principales',
      pickPathology: 'Pathologie à expliquer',
      primaryOption: 'Diagnostic principal',
    },
    status: {
      completed: 'terminé',
      processing: 'en cours',
    ...
    hrv: {
      ...
      names: {
        ...
        pNN50: 'Intervalles NN successifs différant de plus de 50 ms',
      },
    },
    table: {
      code: 'Code',
      ...
      maybeNote: '{margin}% de son seuil — au plus près de la détection',
      ...
      legendMaybe: 'Probable (au plus près du seuil)',
